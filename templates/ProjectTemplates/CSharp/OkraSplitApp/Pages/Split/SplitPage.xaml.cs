...
namespace $safeprojectname$.Pages.Split
{
    ...
    /// </summary>
    [PageExport("Split")]
    public sealed partial class SplitPage : $safeprojectname$.Common.LayoutAwarePage
    {
        public SplitPage()
        {
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (DataContext is SplitViewModel)
                ((SplitViewModel)DataContext).PropertyChanged += ViewModel_PropertyChanged;
        }
